      ...
      <Slide in={open} direction="up">
        ...
        >
          ...
          <div style={{ margin: 8, marginTop: 32 }}>
            <Typography>
              Scan this QR code on your mobile device or click <b>COPY LINK</b>{' '}
              and pasete into a browser to access your recordings on another
              device.
            </Typography>
          </div>
          <div
          ...
          >
            ...
            <Button style={{ backgroundColor: '#fff' }} onClick={onClose}>
              Close
            </Button>
          </div>
        </div>
